...
export const ACCEPT_TOKEN = 'ACCEPT_TOKEN';

export const ACCEPT_LIQUIDITY_TOKEN = 'ACCEPT_LIQUIDITY_TOKEN';
export const LEND_TOKEN = 'LEND_TOKEN';
export const AMOUNT_SENT = 'AMOUNT_SENT';
